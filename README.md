...
## 概　 要    
QGISへ今昔マップのタイルマップを一括登録するためのXMLファイルです．

本データセットは2021.3.1現在の今昔マップで公開されているタイルマップについて収録しています．  
QGISへの一括登録の方法は，こちらを一読ください．


## データセット概要     
+ **データ形式**：　KML（Keyhole Markup Language）  
+ **データ構成**：　「XYZ_tile」フォルダの配下にあるkmlに，それぞれのタイルマップが格納されています．
...
1. QGISを立ち上げ，「XYZ_Tiles」>「接続をロード」からkmlファイルを読み込んでください．
